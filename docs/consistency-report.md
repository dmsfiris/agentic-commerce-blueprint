...
The runtime modules consistently enforce strict date normalization, evidence identity and explicit content hashes, freshness dependency identity and conservative horizon merging, protected decision identity, action-aware result precedence, payment non-evaluation before actor-authority and checkout prerequisites, semantic section coherence, token-based reason classification, canonical generated-claim precedence and axis coherence, verified direct parent-projection binding, deterministic dependency ordering, causal multi-hop refusal propagation, explicit lineage overflow, Ed25519 metadata and key validation, hash recomputation, exact reason/component reconciliation, and live request rebinding at verified external projection.
